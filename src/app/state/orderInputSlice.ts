...
// "side" relative to the specifiedToken, while Phutirix sets it based on
...
// Convert Alphadex side to user-facing side in Phutirix. Phutirix defines
...
async function createTx(state: RootState, rdt: RDT) {
  ...
  // https://github.com/Phutirix-on-Radix/website/issues/486
